...
// Theme strings.
$string['activecourses'] = 'Aktive Kurse';
$string['activeenrollments'] = 'Aktive Einschreibungen';
$string['adminarea'] = 'Blöcke in diesem Bereich sind nur für Administratoren sichtbar.';
$string['alert'] = 'Alarm';
...
$string['cardtitle'] = 'Karten-Titel';
$string['circlescolor'] = 'Circles Farbe';
$string['choosereadme'] = 'standartrema basiert auf dem neuen Moodle Boost theme und nutzt Bootstrap4 und Mustache-Templates.';
...
$string['defaultfrontpagefooter'] = 'Startseiten-Fußbereich';
$string['defaultfrontpagefooter_desc'] = 'Standartinhalt für Startseiten-Fußbereich';
...
$string['privacy:metadata'] = 'Das standartrema Theme speichert keinerlei Nutzerdaten.';
...
$string['showmycourses_desc'] = 'Zeige eingeschriebene Kurse in navbar';
$string['styleguide'] = 'Style Guide';
$string['systemsecurity'] = 'Systemsicherheit';
...
$string['rawscsspre_desc'] = 'SCSS oder CSS Code vor allem anderen einfügen. Meistens werden hier Variablen definiert.';

...
$string['choosereadme'] = 'standartrema is built on to the new Moodle Boost theme, using Bootstrap4 and Mustache templates.';
$string['configtitle'] = 'standartrema';
...
$string['enablestandartrematopics'] = 'Enable standartrema Course Style for Topics';
$string['enablestandartrematopics_desc'] = 'Enable standartrema Course Style for Course format Topics: <br> <img class="img-responsive" src="{$a}"/>';
$string['enablestandartremalines'] = 'Enable standartrema Lines';
$string['enablestandartremalines_desc'] = 'Enable standartrema Lines: <br> <img class="img-responsive" src="{$a}"/>';
...
$string['enablefooterinfo'] = 'Enable Footer Info and standartrema info';
...
$string['footertitle'] = 'Theme standartrema';
...
$string['pluginname'] = 'standartrema';
$string['preset'] = 'Theme preset';
$string['preset_desc'] = 'Pick a preset to broadly change the look of the theme.';
$string['privacy:metadata'] = 'The standartrema theme does not store any individual user data.';
...
$string['subtitle_default'] = 'This is the default subtitle. You can modify or remove this in the standartrema theme settings.';
$string['defaultfooter_default'] = '<div class="row">
	<div class="col-md-8">
		<h3 class="-align-center">standartrema Solutions in Technology</h3>
	...
	<div class="col-md-4">
		...
		<ul class="labeled-icons">
			<li>
                ...
                <a href="https://standartrema.tech/" target="_blank" style="cursor: pointer;">
                    <p>https://standartrema.tech/</p>
                </a>
            </li>
			<li>
                <span class="fa fa-github fa-2x"></span>
                <a href="https://github.com/standartrema-tech/" target="_blank" style="cursor: pointer;">
                    <p>https://github.com/standartrema-tech/</p>
                </a>
            </li>
		</ul>
	</div>
...
// Footer settings.
$string['enablestandartremafooter'] = 'Enable standartrema Footer';
$string['enablestandartremafooter_desc'] = 'Enable standartrema Footer instead of Boost popup footer';

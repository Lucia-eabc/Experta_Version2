...
if ($numberofimages > 1) {
    ...
    for ($i = 1; $i <= $numberofimages; $i++) {
        ...
        $url      = theme_standartrema_setting_file_url("frontpageimage{$i}", "frontpageimage{$i}", $PAGE->theme);
...
$templatecontext = [
    ...
    'cardssettings' => theme_standartrema_get_cards_settings(),
...
echo $OUTPUT->render_from_template('theme_standartrema/frontpage', $templatecontext);

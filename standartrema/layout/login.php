...
/**
 * standartrema login page layout.
 *
...
$loginstyle = get_config('theme_standartrema', 'loginpagestyle');
$additionalclasses = [
...
if ($particlesconfig = $loginstyle == "particle-circles") {
    $particlesconfig = json_decode(file_get_contents("$CFG->dirroot/theme/standartrema/particles.json"));
    $particlesconfig->particles->color->value = get_config("theme_standartrema", "particles_circlescolor");
...
echo $OUTPUT->render_from_template('theme_standartrema/login', $templatecontext);

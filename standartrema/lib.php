 ...
 * @return string
 */
function theme_standartrema_get_main_scss_content($theme) {
    global $CFG;

    $scss = '';
    $scss .= file_get_contents("$CFG->dirroot/theme/standartrema/scss/defaultvariables.scss");

    $filename = !empty($theme->settings->preset) ? $theme->settings->preset : 'standartrema.scss';

    $scss .= file_get_contents("$CFG->dirroot/theme/standartrema/scss/preset/{$filename}");

    if (!empty($theme->settings->enablestandartrematopics)) {
        $scss .= file_get_contents("$CFG->dirroot/theme/standartrema/scss/standartrema/topics.scss");
    }

    if (empty($theme->settings->enablestandartremalines)) {
 ...
 * @return string
 */
function theme_standartrema_get_pre_scss($theme) {
    $scss = '';
    $configurable = [
 ...
 * @return bool
 */
function theme_standartrema_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {

...
/**
 * Class standartrema_admin_settings_styleguide
 *
 * @package     theme_standartrema
 * @copyright   2019 standartrema - {@link https://standartrema.tech/}
 * @author      Rodrigo Mady
 ...
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class standartrema_admin_settings_styleguide extends admin_setting_heading {
    ...
    public function output_html($data, $query = '') {
        ...
        return $OUTPUT->render_from_template('theme_standartrema/admin_setting_styleguide', $context);
    }

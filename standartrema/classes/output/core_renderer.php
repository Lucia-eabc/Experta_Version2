...
namespace theme_standartrema\output;
...
class core_renderer extends \theme_boost\output\core_renderer {
    ...
    public function frontpage_settings_menu() {
        ...
        return $this->render_from_template('theme_standartrema/frontpage_settings_menu', $header);
    }
    ...
    public function render_lang_menu($showlang = false) {
        ...
        if ($haslangmenu) {
            ...
            if (isset($context)) {
                return $this->render_from_template('theme_standartrema/lang_menu', $context);
            }
        }
    }
    ...
    protected function render_custom_menu(custom_menu $menu) {
        if ($showmycourses = get_config('theme_standartrema', 'showmycourses')) {
    ...
    public function render_login(\core_auth\output\login $form) {
        ...
        $context->loginpagecreatefirst = get_config('theme_standartrema', 'loginpagecreatefirst');

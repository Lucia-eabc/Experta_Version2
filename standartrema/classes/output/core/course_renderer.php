 ...
 */
namespace theme_standartrema\output\core;
    ...
    protected function coursecat_coursebox_content(coursecat_helper $chelper, $course) {
        ...
        if (!isset($showcategories)) {
            ...
            $showcategories = $chelper->get_show_courses() == self::COURSECAT_SHOW_COURSES_EXPANDED_WITH_CAT ||
                    (get_config('theme_standartrema', 'showcategories') && $PAGE->pagetype == 'site-index');
        }
        ...
        $content .= "<h4 class='card-title text-center mt-1'>". $coursenamelink ."</h4>";
        $content .= html_writer::end_tag('div');
        ...
        if ($course->has_course_contacts()) {
            $content .= html_writer::start_tag('div', array('class' => 'teachers mb-4'));
            $content .= html_writer::start_tag('ul', array('class' => 'list-unstyled pb-3 px-3 font-weight-light'));
        ...
        if ($course->has_summary()) {
            $summarytype = get_config('theme_standartrema', 'summarytype');
            ...
            if ($summarytype == 'popover') {
                ...
                $content .= get_string('seemore', 'theme_standartrema');
                $content .= html_writer::end_tag('div');
                ...
                $content .= $this->output->render_from_template('theme_standartrema/course_summary_modal', $modal);
            }
        }
